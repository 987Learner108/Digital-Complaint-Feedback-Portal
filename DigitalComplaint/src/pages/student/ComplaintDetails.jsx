...
const ComplaintDetails = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      await API.put(`/details/${editComplaint._id}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
          ...
          <div className="complaint-card" key={comp._id}>
            {editComplaint && editComplaint._id === comp._id ? (
              <form onSubmit={handleEditSubmit} className="edit-form">
                ...
                />
                {formErrors.assignTo && (
                  <span className="error">{formErrors.assignTo}</span>
                )}
              ...
              <>
                ...
                <p>
                  <strong>Assign To:</strong> {comp.assignTo}
                </p>
                <p>
                ...
                {comp.attachment && (
                  <div className="complaint-attachment">
                    ...
                    {comp.attachment.endsWith(".pdf") ? (
                      <a href={comp.attachment} target="_blank" rel="noopener noreferrer">
                        View PDF Attachment
                      </a>
                    ) : (
                      <img src={comp.attachment} alt="Complaint Attachment" />
                    )}
                  </div>
                )}
