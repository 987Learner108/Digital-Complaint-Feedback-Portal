        ...
        <div className="status-details">
          ...
          {currentComplaint.attachment && (
            <div className="complaint-attachment">
              <h4>Attachment</h4>
              {currentComplaint.attachment.endsWith(".pdf") ? (
                <a href={currentComplaint.attachment} target="_blank" rel="noopener noreferrer">
                  View PDF Attachment
                </a>
              ) : (
                <img src={currentComplaint.attachment} alt="Complaint Attachment" />
              )}
            </div>
          )}
        </div>
